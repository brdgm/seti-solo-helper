<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/418059/seti-search-for-extraterrestrial-intelligence" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Tomáš Holek</dd>
        <dt>Artist</dt>
        <dd>Ondřej Hrdina, Oto Kandera, Jiří Kůs, Jakub Lang, Michaela Lovecká, Jiří Mikovec, Jakub Politzer, Petra Ramešová, František Sedláček, Petr Štich, Petr Štich (III), Josef Surý </dd>
        <dt>Publisher</dt>
        <dd><a href="https://www.czechgames.com/" target="_blank" rel="noopener">Czech Games Edition</a>.</dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/seti-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/seti-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/seti-solo-helper</a></dd>
      </dl>
